...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <Router>
          ...
          {#if projectView && projectID}
            <li class="nav-item">
              <Link to="/projects/{projectID}/test-plans/" class="nav-link"
                >Test Plans</Link
              >
            </li>
            <li class="nav-item">
              <Link to="/projects/{projectID}/requirements/" class="nav-link"
                >Requirements</Link
              >
            </li>
            <li class="nav-item">
              <Link to="/projects/{projectID}/test-suites/" class="nav-link"
                >Test Suites</Link
              >
            </li>
            <li class="nav-item">
              <Link to="/projects/{projectID}/runs/" class="nav-link"
                >Test Runs</Link
              >
            </li>
          {/if}
    ...
    <Dropdown>
      <span slot="dropdown-toggle" class="user_photo_nav">
        {#if $userStore}
      ...
      <span slot="dropdown-li">
        <li>
          <Link to="/settings/" class="dropdown-item setting-drop"
            >Settings</Link
          >
        </li>
        <li>
          <Link to="/auth/logout/" class="dropdown-item setting-drop"
            >Logout</Link
          >
        </li>
      </span>
